        ...
        <div className="hidden lg:flex items-stretch justify-center gap-0">
          {CompanyFeatures.map((feature, index) => (
            <motion.div
              ...
              className={`flex flex-col items-center justify-start gap-5 py-8 px-4 border-2 border-[#EEE] ${index === 0
            ...
            >
              ...
              <p className={`text-center font-thin text-black leading-relaxed ${index === 0 ? "text-sm sm:text-sm" : "text-xs sm:text-sm"
                }`}>
                {feature.description}
              </p>
            </motion.div>
